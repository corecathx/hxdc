...
class DiscordClient {
    ...
    **/
    public function changeStatus(status:String, ?type:String, ?presence:String, ?afk:Bool = false)
    {
        ...
        var data:{op:Int,d:{since:Dynamic,activities:Dynamic,status:Dynamic,afk:Dynamic}} = null;
        var numericType:Int = 0;
        if (type != null && presence != null)
        {
            ...
            data = {
                ...
                d: {
                    ...
                    activities: [
                        switch (numericType) {
                            case 4: { type: 4, state: presence };
                            default: { type: numericType, name: presence };
                        }
                    ],
                    status: status,
                    afk: afk
    ...
    **/
    ...
    public function nMessage(ms:MessageS, d:Dynamic) {
        ...
        daUser.global_name = d.author.global_name;
